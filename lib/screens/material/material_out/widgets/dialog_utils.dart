...
class DialogUtils {
  ...
  static void showCustomDialog(BuildContext context,
    ...
    showDialog(
        ...
        builder: (_) {
          return AlertDialog(
            title: Text(title,textAlign: TextAlign.center,style: GoogleFonts.poppins(
                  textStyle: const TextStyle(
                color: Color(0xffFF0000),
                fontWeight: FontWeight.w500,
                fontSize: 20,
              )),),
            content:  Text('This is an irreversible action. Do you want to proceed?',textAlign: TextAlign.center,style: GoogleFonts.poppins(
                  textStyle: const TextStyle(
    ...
    showDialog(
        ...
        builder: (_) {
          return AlertDialog(
            ...
            content:  Text('Are you sure you want to delete this item?',textAlign: TextAlign.center,style: GoogleFonts.poppins(
                  textStyle: const TextStyle(
                color: Color(0xff000000),
                fontWeight: FontWeight.w500,
                fontSize: 20,
