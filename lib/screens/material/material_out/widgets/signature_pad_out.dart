...
class SignaturePadOut extends StatefulWidget {
  const SignaturePadOut({super.key});

  @override
  State<SignaturePadOut> createState() => _SignaturePadOutState();
}

class _SignaturePadOutState extends State<SignaturePadOut> {
