...
class ClientRepository {
  ...
  Future<dynamic> searchClient(String clientName) async {
    dynamic response = await _apiService.getApi('${AppUrl.searchClientListApi}$clientName');
    return response;
  }
  ...
  Future<dynamic> sendRequestClientApi(var data) async {
    dynamic response = await _apiService.postWithTokenApi(data,AppUrl.sendRequestClientApi);
    return response;
  }

  Future<dynamic> requestDeclinedClientApi(var data) async {
    dynamic response = await _apiService.postWithTokenApi(data,AppUrl.clientRequestDeclinedApi);
    return response;
  }

  Future<dynamic> requestAcceptClientApi(var data) async {
    dynamic response = await _apiService.postWithTokenApi(data,AppUrl.clientRequestAcceptApi);
    return response;
  }

  Future<dynamic> getClientInventoryMaterial(String accountId) async {
    dynamic response = await _apiService.getApi('${AppUrl.clientInventoryMaterialList}$accountId');
    return response;
  }

  Future<dynamic> getClientInventoryUnit(String accountId,String materialId) async {
    dynamic response = await _apiService.getApi('${AppUrl.clientInventoryUnitList}$materialId?account_id=$accountId');
    return response;
  }

  Future<dynamic> getClientInventoryTransactions(String accountId,String categoryId, String materialId,String unitId) async {
    dynamic response = await _apiService.getApi('${AppUrl.clientInventoryTransactionsList}account_id=$accountId&category_id=$categoryId&material_id=$materialId&unit_id=$unitId');
    return response;
  }

  Future<dynamic> getClientInventoryTransactionsDtails(String transactionsId,String accountId) async {
    dynamic response = await _apiService.getApi('${AppUrl.clientInventoryTransactionsDetails}$transactionsId?account_id=$accountId');
    return response;
  }
