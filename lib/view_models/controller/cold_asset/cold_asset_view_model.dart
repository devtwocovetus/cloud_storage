...
class ColdAssetViewModel extends GetxController {
  ...
  void submitAddAsset() {
    ...
    Map data = {
      ...
      'serial_number': Utils.textCapitalizationString(serialNumberController.value.text.toString()),
      ...
      'condition': Utils.textCapitalizationString(conditionController.value.text.toString()),
