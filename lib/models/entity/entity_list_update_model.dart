class EntityListUpdateModel {
  int? status;
  String? message;
  Pagination? pagination;
  List<EntityUpdate>? data;

  EntityListUpdateModel({this.status, this.message, this.pagination, this.data});

  EntityListUpdateModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    ...
    if (json['data'] != null) {
      data = <EntityUpdate>[];
      json['data'].forEach((v) {
        data!.add(EntityUpdate.fromJson(v));
      });
    }
  }
...
class EntityUpdate {
  ...
  String? validFrom;
  String? validTo;
  List<EntityBinUpdateMaster>? entityBinMaster;
  int? entityType;
  String? farmSize;
  ...
  EntityUpdate.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    email = json['email'];
    ...
    if (json['entity_bin_master'] != null) {
      entityBinMaster = <EntityBinUpdateMaster>[];
      json['entity_bin_master'].forEach((v) {
        entityBinMaster!.add(EntityBinUpdateMaster.fromJson(v));
      });
    }
...
class EntityBinUpdateMaster {
  ...
  EntityBinUpdateMaster.fromJson(Map<String, dynamic> json) {
    id = json['id'];
