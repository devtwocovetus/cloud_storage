class ClientInventoryUnitList {
  int? status;
  String? message;
  Pagination? pagination;
  List<ClientInventoryUnit>? data;

  ClientInventoryUnitList(
      {this.status, this.message, this.pagination, this.data});

  ClientInventoryUnitList.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    ...
    pagination = json['pagination'] != null
        ...
        : null;
    if (json['data'] != null) {
      data = <ClientInventoryUnit>[];
      json['data'].forEach((v) {
        data!.add(ClientInventoryUnit.fromJson(v));
      });
    }
  }
...
class ClientInventoryUnit {
  ...
  ClientInventoryUnit.fromJson(Map<String, dynamic> json) {
    unitId = json['unit_id'];
