class ClientInventoryTransactionsList {
  int? status;
  String? message;
  Pagination? pagination;
  List<ClientTransaction>? data;

  ClientInventoryTransactionsList(
      {this.status, this.message, this.pagination, this.data});

  ClientInventoryTransactionsList.fromJson(Map<String, dynamic> json) {
    status = json['status'];
    ...
    if (json['data'] != null) {
      ...
      json['data'].forEach((v) {
        data!.add(ClientTransaction.fromJson(v));
      });
    }
  }
